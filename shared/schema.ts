...
export const insertSupplierRatingSchema = createInsertSchema(supplierRatings).omit({
  ...
  // We'll store job description in the overallText field to avoid schema changes
  overallText: z.string().min(5, "Job description and feedback must be at least 5 characters")
});
